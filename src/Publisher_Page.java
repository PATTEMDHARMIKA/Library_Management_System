...
public class Publisher_Page extends JFrame {
    private JTextField nameField;
    private JTable table;
    private DefaultTableModel model;

    public Publisher_Page() {
        setTitle("Publisher Page");
        setBounds(100, 100, 500, 400);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        getContentPane().setLayout(null);

        JLabel lblTitle = new JLabel("Publishers");
        ...
        JButton addBtn = new JButton("Add Publisher");
        addBtn.setBounds(360, 60, 120, 25);
        getContentPane().add(addBtn);

        model = new DefaultTableModel();
        model.setColumnIdentifiers(new String[]{"Publisher ID", "Name"});
